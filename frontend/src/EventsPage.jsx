          ...
          {events.map(e => (
            <TableRow key={e.id}>
              ...
              <TableCell>
                ...
                <Button onClick={() => navigate(`fowcpevents20240928105048.azurewebsites.net/api/FOWCPEventSignup?code=2R7-QJayuS3kFRIhlH2N-FhF0xSCQIKgLrotyAAEBHgsAzFuw1G4hQ==&eventid=${e.EventId}`)}>View</Button>
